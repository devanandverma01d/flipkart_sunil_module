...
(async () => {
    ...
    // const InstanId = uuidv4();
    const flink = 'https://www.flipkart.com';
    var plink = 'https://www.flipkart.com/mi-series-80-cm-32-inch-hd-ready-led-smart-google-tv-1-5-gb-ram-dolby-audio-2023-model/p/itm094b23d676f51?pid=TVSGREPAZX8CN9QS&lid=LSTTVSGREPAZX8CN9QSFY3T6T&marketplace=FLIPKART&q=tv&store=ckf%2Fczl&srno=s_1_1&otracker=search&otracker1=search&iid=en_kvkUQsKbUGpBST1GdPJkaObeYzj-HbNARKQNlP1MNtTl-cFFUJGMeUN3G89wzHXAEQ3oRWjaFzarfXN17mI6Zg%3D%3D&ssid=ps25131n680000001692681733843&qH=c9a1fdac6e082dd8';
    const myArray = plink.split("com/")[1];
    const productlink = myArray.split("/")[0];
    const nameset = 'rohit';
    const accountPhoneNo = '7697634314';
    const numberset = '7999452711';
    const pincodeset = '458441';
    const addressset1 = 'chowr neemuch sabji mandi';
    const addressset2 = 'main road banlga no.235';
    const bankname = 'ICICI Bank Credit Card';
    const cardnoset = '4035620541052003';
    const monthset = '03';
    const yearset = '29';
    const cvvset = '169';
    ...
    if (sessions && sessions[0].cookies) {
...
//const otpInput = await newPage.waitForSelector('input.form-control[name="otpPassword"]');
